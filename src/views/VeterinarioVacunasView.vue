  ...
  <div class="granjero-container">
    ...
    <div class="controls">
      ...
      <div class="action-buttons">
        ...
        <button v-if="rol !== 'granjero' " @click="abrirModalRegistrarVacuna">+Registrar vacuna</button>
      </div>
    </div>
    ...
    <table class="tabla-cerdos">
      ...
      <tbody>
        <tr v-for="vacuna in vacunasFiltradas" :key="vacuna.id_vacuna">
          ...
          <td>
            <button class="editar-btn" @click="abrirModalEditarVacuna(vacuna)">✏️</button>
    ...
    <!-- MODAL EDITAR VACUNA -->
    <EditarVacunaModal :mostrar="mostrarModalEditarVacuna" :vacuna="vacunaSeleccionada"
      @cerrar="cerrarModalEditarVacuna" @actualizada="obtenerVacunas" />
...
import EditarVacunaModal from '@/components/EditarVacunaModal.vue';

export default {
  components: { RegistrarVacunaModal, EditarVacunaModal },
  ...
  data() {
    return {
      ...
      nombreUsuario: '',
      mostrarModalEditarVacuna: false,
  ...
  methods: {
    ...
    abrirModalEditarVacuna(vacuna) {
      this.vacunaSeleccionada = vacuna
      this.mostrarModalEditarVacuna = true
    },
    cerrarModalEditarVacuna() {
      this.mostrarModalEditarVacuna = false
    },
