    ...
    <div class="modal-overlay" v-if="mostrar">
      <div class="editar-modal">
        ...
        <div class="imagen-lateral">
          <img class="imagen" src="/editar-cerdo2.jpg" alt="Registrar usuario" />
        </div>
        ...
        <div class="formulario-edicion">
          ...
          <form @submit.prevent="guardarUsuario">
            ...
            <input v-model="nuevoUsuario.apellido" required />
            <br>
            <label>Email:</label>
            <input v-model="nuevoUsuario.direccion" required />
            <br>
            <label>Teléfono:</label>
            <input v-model="nuevoUsuario.telefono" required />
            <br>
...
<style scoped>
/* Se reutilizan los estilos anteriores sin cambios */
.modal-overlay {
  position: fixed;
  top: 0;
  left: 0;
