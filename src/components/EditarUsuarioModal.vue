    ...
    <div class="modal-overlay" v-if="mostrar">
      <div class="editar-modal">
        ...
        <div class="imagen-lateral">
          <img class="imagen" src="/editar-cerdo2.jpg" alt="Editar usuario" />
        </div>
        ...
        <div class="formulario-edicion">
          ...
          <form @submit.prevent="guardarCambios">
            <label>Nombre:</label>
            <input v-model="usuarioEditado.nombre"  />
<br>
            <label>Apellido:</label>
            <input v-model="usuarioEditado.apellido"  />
<br>
            <label>Dirección:</label>
            <input v-model="usuarioEditado.direccion"  />
<br>
            <label>Teléfono:</label>
            <input v-model="usuarioEditado.telefono" />
<br>
            <label>Contraseña:</label>
            <input v-model="usuarioEditado.password" type="password" />
<br>
            <div class="botones">
